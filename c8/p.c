...
printf("Closest palindrome found for up :: %d\n",arrup[0]);
...
(subup<subdown)?printf("The closest palindrome to %d is %d.\n",fordetail,arrup[0]):printf("The closest palindrome to %d is %d.\n",fordetail,arrdown[0]);

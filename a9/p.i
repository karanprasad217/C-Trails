...
switch(op3){
case '+' : printf("The sum of two numbers %d & %d is ::: ""\x1b[32m""%d.\n ""\x1b[0m",op1,op2,op1+op2);break;
case '-' : printf("The subtraction of two numbers %d & %d is ::: ""\x1b[32m""%d.\n ""\x1b[0m",op1,op2,op1-op2);break;
case '*' : printf("The multiplication of two numbers %d & %d is ::: ""\x1b[32m""%d.\n ""\x1b[0m",op1,op2,op1*op2);break;
case '/' : printf("The division of two numbers %d & %d is ::: ""\x1b[32m""%d.\n ""\x1b[0m",op1,op2,op1/op2);break;

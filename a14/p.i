...
do{
 if(num1%check==0){
  printf("Other factors ::: ""\x1b[45m"" %d\n""\x1b[0m",check);
  notprime++;
 }
 else{
  prime++;
...
(notprime!=0)?printf("\x1b[45m""No,""\x1b[0m"" the number %d is ""\x1b[45m""not a prime.\n""\x1b[0m",num1):printf("\x1b[45m""Yes,""\x1b[0m"" the number %d ""\x1b[45m""is a prime.\n""\x1b[0m",num1);
return 0;
}

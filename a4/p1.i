...
printf("\x1b[44m""FAHRANHEIT TO CELSIUS CONVERTER\n""\x1b[0m");
printf("\x1b[33m""This program will take the lower bound temperature, upper bound temperature and a step constant from the user.\n\n""\x1b[0m");
